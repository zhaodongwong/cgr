    ...
    <div className="w-full min-h-screen bg-black flex justify-center ">
      ...
      <div className='mt-4'>
       ...
       <div className='mt-5 flex items-center flex flex-col'>
         <input value={query} onChange={(e) => setQuery(e.target.value)} type="text" placeholder="Type to search" className='flex-1 p-2 pr-40 border-zinc-200 border-2 placeholder-zinc-300 pb-2 text-2xl bg-black focus:bg-white rounded-full'/>
